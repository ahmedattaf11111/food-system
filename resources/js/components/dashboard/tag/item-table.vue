      ...
      <div class="col-lg-9 order-lg-1 order-2 table-sec">
        <div id="table" class="bg-white border border-radius-4 mb-30">
          <div class="table-container">
            <div class="controls">
              <div class="row">
                <div class="col-lg-10" style="padding: 0 5px">
            ...
            <div class="table-responsive">
              <table class="table" id="printMe">
                <thead>
                  <tr>
                    <th style="width: 10%" scope="col">{{ $t("S/L") }}</th>
                    <th style="width: 80%" scope="col">{{ $t("NAME") }}</th>
                    <th style="width: 10%" class="actions-header" scope="col">
                      {{ $t("ACTIONS") }}
                    </th>
                  </tr>
                </thead>
        ...
        <div id="add" class="bg-white border border-radius-4 mb-30">
          <div class="create-item">
            <div class="title mb-4">{{ $t("ADD_NEW_TAG") }}</div>
            <form>
              <div class="row">
      ...
      >
        ...
        >
          <div class="information">
            <div class="title">{{ $t("TAG_INFORMATION") }}</div>
            <ul>
...
import tagClient from "../../../http-clients/admin/tag-client";
...
export default {
  ...
  setup() {
    ...
    function toggleStatus(id) {
      tagClient.toggleStatus(id).then((res) => {
    ...
    function downloadExcelFile() {
      tagClient.getAllItems().then((res) => {
        let data = res.data;
