      ...
      <div class="col-lg-9 order-lg-1 order-2 table-sec">
                    ...
                    <td class="actions-cell">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-left">
                          <router-link
                            class="dropdown-item"
                            :to="`/admin/variations-form/${item.id}`"
                            >{{ $t("EDIT") }}</router-link
                          >
                          <router-link
                            class="dropdown-item"
                            :to="`/admin/variation-values/${item.id}/${item.name_ar}/${item.name_en}`"
                            >{{ $t("ADD_VALUES") }}</router-link
                          >
                        </div>
                      </div>
                    </td>
        ...
        <div id="add" class="bg-white border border-radius-4 mb-30">
          <div class="create-item">
            <div class="title mb-4">{{ $t("ADD_NEW_VARIATION") }}</div>
            <form>
              <div class="row">
      ...
      >
        ...
        >
          <div class="information">
            <div class="title">{{ $t("VARIATION_INFORMATION") }}</div>
            <ul>
...
import variationClient from "../../../http-clients/admin/variation-client";
...
export default {
  ...
  setup() {
    ...
    function toggleStatus(id) {
      variationClient.toggleStatus(id).then((res) => {
    ...
    function downloadExcelFile() {
      variationClient.getAllItems().then((res) => {
        let data = res.data;
