  ...
  <div class="location-container">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-sm-12 text-right">
          <router-link
            ...
            :to="`/admin/locations-form/create`"
          >
            <svg
    ...
    <div id="table" class="bg-white border border-radius-4 mb-30">
      <div class="table-container">
        <div class="controls">
          <div class="row">
            <div style="padding: 0 8px; width: 72%">
          ...
          <table class="table" id="printMe">
            <thead>
              <tr>
                ...
                <th style="width: 13%" scope="col">{{ $t("DEFAULT") }}</th>
                <th style="width: 19%" scope="col">{{ $t("PUBLISHED") }}</th>
            ...
            <tbody v-if="items.length">
              <tr v-for="(item, index) in items" :key="item.id">
                ...
                <td>
                  <label class="switch">
                    <input
                      @change="togglePublished(item.id)"
                      type="checkbox"
                ...
                <td class="actions-cell">
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-left">
                      <router-link
                        class="dropdown-item"
                        :to="`/admin/locations-form/${item.id}`"
                        >{{ $t("EDIT") }}</router-link
                      >
                      <a
...
import locationClient from "../../../http-clients/admin/location-client";
...
export default {
  ...
  setup() {
    ...
    function toggleDefault(id) {
      locationClient.toggleDefault(id).then((res) => {
    ...
    function togglePublished(id) {
      locationClient.togglePublished(id).then((res) => {
        toast.success(t("UPDATED_SUCCESSFULLY"), {
          autoClose: 2000,
          position: "top-center",
        });
    ...
    function downloadExcelFile() {
      locationClient.getAllItems().then((res) => {
        let data = res.data;
