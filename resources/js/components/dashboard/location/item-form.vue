    ...
    <div class="page-header border" style="margin-top: 10px">
      <div class="row">
        <div class="col-md-6 col-sm-12">
          <div class="title">
            {{
              params.id == "create" ? $t("ADD_LOCATION") : $t("UPDATE_LOCATION")
            }}
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-3 order-lg-2 order-1">
        ...
        >
          <div class="information">
            <div class="title">{{ $t("LOCATION_INFORMATION") }}</div>
            <ul>
              <a
  ...
  setup(props, context) {
    ...
    function setForm() {
      if (route.params.id != "create") {
        locationClient.getItem(route.params.id).then((res) => {
    ...
    function getBrands() {
      locationClient.getBrands().then((res) => (data.brands = res.data));
    }
