      ...
      <div class="row">
        <div class="col-md-6 col-sm-12">
          <div class="title">
            {{
              `${$t("VALUES")} - ${
                $i18n.locale == "ar" ? params.name_ar : params.name_en
              }`
            }}
          </div>
        </div>
      ...
      <div class="col-lg-9 order-lg-1 order-2 table-sec">
              ...
              <table class="table" id="printMe">
                <thead>
                  <tr>
                    ...
                    <th style="width: 29%" scope="col">{{ $t("STATUS") }}</th>
                    ...
                    <td class="actions-cell">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-left">
                          <router-link
                            class="dropdown-item"
                            :to="`/admin/variation-values-form/${item.id}`"
                            >{{ $t("EDIT") }}</router-link
                          >
                        </div>
                      </div>
        ...
        <div id="add" class="bg-white border border-radius-4 mb-30">
          <div class="create-item">
            <div class="title mb-4">{{ $t("ADD_NEW_VARIATION_VALUE") }}</div>
            <form>
              <div class="row">
...
import variationValueClient from "../../../http-clients/admin/variation-value-client";
...
export default {
  ...
  setup() {
    ...
    function toggleStatus(id) {
      variationValueClient.toggleStatus(id).then((res) => {
    ...
    function downloadExcelFile() {
      variationValueClient.getAllItems().then((res) => {
        let data = res.data;
