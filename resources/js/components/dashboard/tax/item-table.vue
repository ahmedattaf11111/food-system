      ...
      <div class="col-lg-9 order-lg-1 order-2 table-sec">
        ...
        <div id="add" class="bg-white border border-radius-4 mb-30">
          <div class="create-item">
            <div class="title mb-4">{{ $t("ADD_NEW_TAX") }}</div>
            <form>
              <div class="row">
      ...
      >
        ...
        >
          <div class="information">
            <div class="title">{{ $t("TAX_INFORMATION") }}</div>
            <ul>
...
export default {
  ...
  setup() {
    ...
    function toggleStatus(id) {
      taxClient.toggleStatus(id).then((res) => {
    ...
    function downloadExcelFile() {
      taxClient.getAllItems().then((res) => {
        let data = res.data;
