      ...
      <div class="col-lg-9 order-lg-1 order-2 table-sec">
        ...
        <div id="add" class="bg-white border border-radius-4 mb-30">
          <div class="create-item">
            <div class="title mb-4">{{ $t("ADD_NEW_UNIT") }}</div>
            <form>
              <div class="row">
      ...
      >
        ...
        >
          <div class="information">
            <div class="title">{{ $t("UNIT_INFORMATION") }}</div>
            <ul>
...
import unitClient from "../../../http-clients/admin/unit-client";
...
export default {
  ...
  setup() {
    ...
    function toggleStatus(id) {
      unitClient.toggleStatus(id).then((res) => {
    ...
    function downloadExcelFile() {
      unitClient.getAllItems().then((res) => {
        let data = res.data;
